...
\author{Achmadi and Purwadi Agus Darwito % <-this % stops a space
%\thanks{}
}
...
% The paper headers
%\markboth{IEEE SENSORS JOURNAL, VOL. 17, NO. 6, MARCH 15, 2017}%
...
%\boldmath
%\blindtext[1]
Modern sensors consist of arrays of detectors specially arranged to enhance precision, capabilities, and field of view (FOV). 
Sensor arrays can have multiple functionalities, such as the simultaneous detection of position andmotion.
